Below are the two deliverables, written so you can drop them straight into a deck or memo.

---

# 1-page Executive Summary (PRD – Executive Version)

## Product: Meta-Thought Engine (MTE)

### What it is

The Meta-Thought Engine is a **procedural intelligence layer** that models how problems are solved—not just what answers are produced. It transforms raw reasoning traces into reusable, auditable **problem-solving procedures** and enforces safe reasoning paths for high-risk situations.
...
Humans solve most problems using a small number of reusable procedures (debug loops, design funnels, verification gates). MTE captures and operationalizes these procedures.

### What it delivers

MTE enables systems to:
...
**MTE turns reasoning from an opaque byproduct into a first-class, reusable, and governable asset.**
